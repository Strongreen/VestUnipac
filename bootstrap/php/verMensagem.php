	...
	<section id="contato">
		<div class="container">
			<div class="row">
				...
				<h4 class="text-muted">Lista de mensagens.</h4>
				</div>
			</div>
			<br>
		</div>
...
$sql = "SELECT * FROM `contato` AS contato WHERE id= '$_REQUEST[id]'";
...
while ($login = $resultado->fetch_object()) {
  // Exibe a notícia dentro de um bloco HTML
	...
	echo 	'<tr>
				...
				<td style="white-space: pre-wrap; text-align:justify">' .$login->mensagem. '</td>
			</tr>';
} 
	echo '</tbody></table>';
	echo '<a class="btn btn-sm btn-primary col-lg-12 " align="center" href="consultaMensagem.php">VOLTAR</a>';
// while ($login = $resultado->fetch_object())
