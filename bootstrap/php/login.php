	...
	<section id="contato">
		<div class="container">
			<div class="row">
				...
				<h4 class="text-muted">Realize o login, para ter acesso a sua respectiva área.</h4>
				<br><br>
				</div>
			</div>
			<br><br><br><br>
			<div class="col-lg-12 text-center">
				<ul>
					<li><a href="loginAdmin.php" class="btn btn-lg btn-primary">ADMIN</a>
					<a href="loginAluno.php" class="btn btn-lg btn-primary">ALUNO</a></li>
				</ul>
			</div>
		</div>
	</section>
