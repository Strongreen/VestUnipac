...
<body class="homepage">
	...
	<section id="contato">
		<div class="container">
			...
			<div class="col-lg-12 text-center">
				<ul>
					<li><a href="consultaUser.php" class="btn btn-lg btn-primary">USERS ADMIN</a>
					<a href="consultaVestibular.php" class="btn btn-lg btn-primary">INCRIÇÕES</a>					
					<a href="consultaCursos.php" class="btn btn-lg btn-primary">CURSOS</a>					
					<a href="consultaMensagem.php" class="btn btn-lg btn-primary">MENSAGENS</a></li>
				</ul>
			</div>
		</div>
	</section>
